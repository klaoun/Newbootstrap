...
{combine_script id='jquery.mobile-events' path='themes/newbootstrap_darkroom/node_modules/jQuery-Touch-Events/src/jquery.mobile-events.min.js' require='jquery' load='footer'}
{/if}
